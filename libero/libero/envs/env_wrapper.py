...
class ControlEnv:
    ...
    def initialize_time(self, control_freq):
        """Delegate initialize_time to the underlying environment for async simulation support."""
        return self.env.initialize_time(control_freq)
    ...
    def __getattr__(self, name):
        """Delegate any undefined attributes to the underlying environment."""
        if name == 'env':
